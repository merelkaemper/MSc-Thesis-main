# Feature extraction process for a single graph
import math
...
# Update data paths
distant_df = pd.read_csv('/Users/merelkamper/Documents/MSc Data Science/Thesis/MSc-Thesis-main/adapted/data/station_distances.csv')
population_df = pd.read_csv('/Users/merelkamper/Documents/MSc Data Science/Thesis/MSc-Thesis-main/adapted/data/station_population.csv').fillna(0)

# Create maps with correct column names
distant_map = distant_df.set_index(['origin_name','destination_name']).to_dict()['distance']
population_map = population_df.set_index('Station')['Population'].to_dict()

# This function calculates the gravitational force between pairs of nodes in a graph
# This is based on their population and distance 
...
# This function extracts various features from a sequence of graphs representing different time points
