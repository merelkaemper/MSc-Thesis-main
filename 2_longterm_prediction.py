...
def main(year_start):
    ...
    data = pd.read_csv('/Users/merelkamper/Documents/MSc Data Science/Thesis/MSc-Thesis-main/adapted/data/trajectories_per_day.csv', sep=';')
    data.set_index(['YEAR', 'MONTH', 'DoW'], inplace=True)
    ...
    import pickle
    with open(f'/Users/merelkamper/Documents/MSc Data Science/Thesis/MSc-Thesis-main/adapted/results/'+ f'{str(year_start)}pred_36' +'.pkl', 'wb') as f:
        pickle.dump(out, f)
